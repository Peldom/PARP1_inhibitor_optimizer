...
# def get_mol():
#     train_x = []
#     with open( r'D:\360Downloads\ 操作页面\ORGANIC\data\smallmols_sub.smi','r') as f:
#         for s in f.readlines():
#             train_x.append(s.strip())
#         return train_x
# train_x=get_mol()
# def logP():
#     train_y = []
...
#             train_y.append(Descriptors.MolLogP(mol))
#         return train_y
# train_y=logP()
# cnn_pce = KerasNN('logP')
# cnn_pce.train(train_x,train_y,150,100)