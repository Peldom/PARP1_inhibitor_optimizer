...
try:
    ...
    # 如果你想用Keras写出兼容theano和tensorflow两种backend的代码，那么你必须使用抽象keras backend API来写代码
...
class ORGANIC(object):
    ...
    def train(self, ckpt_dir='checkpoints/'):
        ...
        for nbatch in tqdm(range(self.TOTAL_BATCH)):
            ...
            # batchreward=batch_reward(gen_samples)
            # print(batchreward)
