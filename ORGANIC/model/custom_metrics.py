...
def load_SA(filename=None):
    """
    Loads the parameters required by the synthesis ability metric.
    """
    if filename is None:
...
def load_beauty(filename=None):
    """
    Loads the parameters required by the chemical beauty metric.
    """
    if filename is None:
...
"""
 core func logP: to-do: add multi-metrics to this func if you can't understand
"""
